...
<div class="container" style="margin-top: 50px; max-height: 500px; overflow: scroll;">
    <h1>Оценки за курс ${course.name} клиента ${client.name} </h1>
    ...
    <table class="table table-striped table-bordered">
        ...
        <c:forEach var="mark" items="${marks.marks}" varStatus="i">
            ...
            <tr class="elements">
                ...
                <td><input name="marks[${i.index}].mark" type="number" value="${mark.mark}"></td>
    ...
    <div class="form-group container" style="margin-top: 30px;">
        <table class="table table-striped table-bordered">
            ...
            <tr class="elements">
                ...
                <td><input name="mark.primarykey[1].mark" type="number"></td>
